...
struct thread_data{
    ...
    int wait_to_obtain_ms;      // time before acquiring mutex
    int wait_to_release_ms;     // time to hold mutex before releasing
    bool thread_complete_success; // true when thread completes successfully
};
